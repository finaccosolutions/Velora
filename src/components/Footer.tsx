        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-[#c9baa8] mb-4">
              Discover the essence of luxury with Velora Tradings. We curate the finest fragrances 
              to enhance your personal style and leave a lasting impression.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-[#c9baa8] hover:text-white transition-colors">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-[#c9baa8]">Mumbai, Maharashtra, India</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="h-4 w-4 text-[#c9baa8]" />
                <span className="text-[#c9baa8]">+91 9876543210</span>
              </div>
              <div className="flex items-center space-x-3">
